...
/// <amd-dependency path="dojo/promise/all" name="all" />
...
class CircuitCreation extends declared(Widget) {
    ...
    private open(event:any) {
        ...
        if (event.target.className == CSS.tabLinks) {
            ...
            this.arrayContent.forEach( (panel) => {
        ...
        switch (event.target.id) {
            ...
            case "addPolygon":
                ...
                inClass.move = inClass.view.on("pointer-move", function(pointer) {
                    ...
                    polygonGraphic = new Graphic({geometry: new Polygon(polygon), symbol: fillSymbol});
            ...
            case "addRectangle":
                ...
                inClass.drag = this.view.on("drag", function(event) {
                    ...
                    var fillSymbol = {type: "simple-fill", color: [valueColor[0], valueColor[1], valueColor[2], 0.3], outline: {color: [valueColor[0], valueColor[1], valueColor[2]], width: 0.5}};
                    rectangleGraphic = new Graphic({geometry: new Polygon(polygon), symbol: fillSymbol});
            ...
            case "addBlur":
                ...
                inClass.drag = this.view.on("drag", function(event) {
                    ...
                    var fillSymbol = {type: "simple-fill", color: [valueColor[0], valueColor[1], valueColor[2], 0.3], outline: {color: [valueColor[0], valueColor[1], valueColor[2]], width: 0.5}};
                    blurGraphic = new Graphic({geometry: new Polygon(polygon), symbol: fillSymbol});
    ...
    private identify(event:any, action:String, color:Array<any>, name:any) {
        ...
        function render(response:any) {
            ...
            function polyline(feature:any) {
                ...
                var polylineGraphic = new Graphic({geometry: new Polyline(polyline), symbol: lineSymbol});  
            ...
            function point(feature:any) {
                ...
                var pointGraphic = new Graphic({geometry: new Point(point), symbol: markerSymbol});
    ...
    private addLinks() {
        ...
        let link = <button
            bind={inClass}
            class={(i == 0) ? CSS.tabLinks + ' active' : CSS.tabLinks}
            id={parameters["name"]}
        ...
        >
            ...
            >
                {(inClass.indicateLayerLength[parameters["name"]].custom == 0) ? inClass.indicateLayerLength[parameters["name"]].default : inClass.indicateLayerLength[parameters["name"]].custom}
            </p>
        </div>;
